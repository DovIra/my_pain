...
INSERT INTO AGENCY
SELECT DISTINCT AGENCY,AGENCY_TYPE
FROM resorce;
...
INSERT INTO PRODUCT
select distinct AGENCY,PRODUCT_NAME
from resorce;
...
select agency,PRODUCT_NAME, count(*)
from RESORCE
...
create table PRODUCT_DETAILS(
    ...
    DESTINATION_CODE varchar2(50) DEFAULT null REFERENCES DESTINATION(DESTINATION),
...
select distinct
    AGENCY,PRODUCT_NAME, DISTRIBUTION_CHANNEL, CLAIM, DURATION, DESTINATION, NET_SALES, COMMISION, GENDER, AGE
from resorce;
